...
<li>
   ...
   ?>
    <tr>
      ...
      <td><a href="admin.php?delete=<?= $fetch_accounts['booking_id']; ?>" onclick="return confirm('delete this account? the user related information will also be delete!')" ><i class="fa-solid fa-trash"></a></td>
