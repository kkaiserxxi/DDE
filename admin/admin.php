...
<body>
	...
	<section id="sidebar">
		<a href="dashboard.php" class="brand">
			<span class="text text2">Admins</span>
		</a>
	 <?php
   ...
   ?> 
							<tr>
								...
								<td>
									<?= $fetch_accounts['password']; ?> 
								</td>
								<td><a href="admin.php?delete=<?= $fetch_accounts['admin_id']; ?>"
										onclick="return confirm('delete this account? the user related information will also be delete!')"><i
